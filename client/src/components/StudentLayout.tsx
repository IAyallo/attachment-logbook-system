    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/student/logs" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
            Daily Logs
          </NavLink>
          <NavLink to="/student/sync-queue" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
            Sync Queue
          </NavLink>
        </nav>
